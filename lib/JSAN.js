...
JSAN.VERSION = 0.10; // + little changes

/*
  2006-07-22  Line 280 is modified by Koji Horaguchi for multi browser.
*/
...
JSAN.Request.prototype = {
    ...
    getText: function (url) {
        ...
        try {
            this._req.send(null);
            if (this._req.status == 200 || this._req.status == 0 || this._req.status == 304 || this._req.status == null) ////////////
                //alert(this._req.status);
